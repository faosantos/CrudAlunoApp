...
export default {
  ...
  // Card
  cardDefaultBg: appColors.primaryLight,
  cardBorderColor: appColors.highlight,
  cardBorderRadius: 2,
  ...
  // Spinner
  defaultSpinnerColor: appColors.highlight,
  ...
  subTitleFontSize: 14,
  subtitleColor: appColors.highlight,
  titleFontColor: appColors.highlight,
